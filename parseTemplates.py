...
settings = {
    ...
    "out_resolution": [720, 480],  # same as in addon.xml
    # "out_resolution": [1280, 720],  # same as in addon.xml
    "verbose": False,
...
def ScaleGeneral(sX, base_dim, out_dim, bCeil=False):
